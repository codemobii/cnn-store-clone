  ...
  return (
    <>
      <header className="web_header">
        ...
        {/* The logo container */}
        <div className="web_header-logo_container">
          <div className="web_major-container">
            <div className="logo_container-nav">
              <div className="web_menu-togger">
                {!isMenuOpen ? (
                  <svg
              ...
              <a href="#" className="web_collapsable-logo">
                <img
              ...
              <div className="web_icon-set">
                ...
                <div onClick={handleOpenCart} className="web_menu-togger">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    width="24"
        ...
        {/* The navigation bar */}
        <div className="web_major-container">
          <div className={`web_header-nav_container `}>
            <div
            ...
            <form action className="web_header-searchbar">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width={24}
            ...
            <div className="web_major-container">
              <div className="hero_intro-cont">
                <div>
                  ...
                  <a href="#" className="web_button-border">
                    Shop now
                  </a>
                </div>
              </div>
        ...
        <CartModal handleCloseCart={handleCloseCart} />
      </header>
